...
class generationPalette(Palette):
    def __init__(self, label, edit):
        ...
        self.XSlider2BottomLabelBox.pack_start(self.XSlider1Img, False, False, padding = 5)
        self.XSlider2BottomLabelBox.pack_start(self.XSlider2BottomLabel, False, False, padding = 5)
        self.YSlider2BottomLabelBox.pack_start(self.YSlider1Img, False, False, padding = 5)
        ...
        self.XSlider3BottomLabelBox.pack_start(self.XSlider1Img, False, False, padding = 5)
        self.XSlider3BottomLabelBox.pack_start(self.XSlider3BottomLabel, False, False, padding = 5)
        self.YSlider3BottomLabelBox.pack_start(self.YSlider1Img, False, False, padding = 5)
