...
class propsPalette(Palette):
    def __init__(self, label, edit):
        ...
        self.gridDivisionSlider.set_size_request(200,30)
        ...
        self.panSlider.set_size_request(200,30)
        ...
        self.reverbSlider.set_size_request(200,30)
        ...
        self.attackDurSlider.set_size_request(200,30)
        ...
        self.decayDurSlider.set_size_request(200,30)
        ...
        self.filterCutoffSlider.set_size_request(200,30)
        ...
        self.minimumSlider.set_size_request(200,30)
        ...
        self.maximumSlider.set_size_request(200,30)
        ...
        self.randomSlider.set_size_request(200,30)
