...
#========================================================================================================
        ...
        self.tdFontColor = '#FFFFFF'        # today: font color
        self.tdBGColor = '#708BD0'          # today: background color
...
#========================================================================================================
    ...
    def set_styles(self):
        ...
        html += '} .cssToday' + str(globals()['cal_ID']) + ' { '
        if self.dFontFace: html += 'font-family: ' + self.dFontFace + '; '
        if self.dFontSize: html += 'font-size: ' + str(self.dFontSize) + 'px; '
        if self.tdFontColor: html += 'color: ' + self.tdFontColor + '; '
        if self.tdBGColor: html += 'background-color: ' + self.tdBGColor + '; '
            ...
            while daycount <= stop:
                ...
                for i in range(len(self.weekdays)):
                    ...
                    if (daycount == 1 and i < start) or daycount > stop: content = '&nbsp;'
                        ...
                        if inThisMonth and daycount == curDay: cls = 'cssToday'
                        elif self.year == 1582 and self.month == 10 and daycount == 4: daycount = 14
                        daycount += 1
                        wdays += 1

                    html += self.table_cell(content, cls + str(globals()['cal_ID']), date)
