...
class generationPalette(Palette):
    def __init__(self, label, edit):
        ...
        self.XYButton1 = ImageToggleButton( Config.TAM_TAM_ROOT + '/icons/XYBut.svg', Config.TAM_TAM_ROOT + '/icons/XYButDown.svg', Config.TAM_TAM_ROOT + '/icons/XYButDownClick.svg')
        ...
        self.XYButton2 = ImageToggleButton( Config.TAM_TAM_ROOT + '/icons/XYBut.svg', Config.TAM_TAM_ROOT + '/icons/XYButDown.svg', Config.TAM_TAM_ROOT + '/icons/XYButDownClick.svg')
        ...
        self.XYButton3 = ImageToggleButton( Config.TAM_TAM_ROOT + '/icons/XYBut.svg', Config.TAM_TAM_ROOT + '/icons/XYButDown.svg', Config.TAM_TAM_ROOT + '/icons/XYButDownClick.svg')
