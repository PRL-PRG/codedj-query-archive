...
#
# Created: Sun Mar  2 11:19:28 2008
...
class Ui_option(object):
    def setupUi(self, option):
        ...
        option.resize(QtCore.QSize(QtCore.QRect(0,0,313,310).size()).expandedTo(option.minimumSizeHint()))
        option.setModal(True)

        self.tab_widget = QtGui.QTabWidget(option)
        self.tab_widget.setGeometry(QtCore.QRect(0,0,315,310))
        ...
        self.widget = QtGui.QWidget(self.tab_conn)
        self.widget.setGeometry(QtCore.QRect(7,11,296,261))
        ...
        self.label_name_conn = QtGui.QLabel(self.widget)
        ...
        self.name_conn = QtGui.QLineEdit(self.widget)
        self.name_conn.setObjectName("name_conn")
        self.gridlayout1.addWidget(self.name_conn,1,2,1,2)

        self.label_host_conn = QtGui.QLabel(self.widget)
        ...
        self.host_conn = QtGui.QLineEdit(self.widget)
        self.host_conn.setObjectName("host_conn")
        self.gridlayout1.addWidget(self.host_conn,2,2,1,2)

        self.label_port_conn = QtGui.QLabel(self.widget)
        ...
        self.connect_conn = QtGui.QPushButton(self.widget)
        self.connect_conn.setEnabled(False)
        self.connect_conn.setMinimumSize(QtCore.QSize(85,0))
        self.connect_conn.setIcon(QtGui.QIcon(":/images/button-connect.png"))
        self.connect_conn.setObjectName("connect_conn")
        self.hboxlayout.addWidget(self.connect_conn)

        self.save_conn = QtGui.QPushButton(self.widget)
        ...
        self.delete_conn = QtGui.QPushButton(self.widget)
        ...
        self.layoutWidget = QtGui.QWidget(self.tab_alias)
        ...
        self.label_conn_alias = QtGui.QLabel(self.layoutWidget)
        ...
        self.list_conn_alias = QtGui.QComboBox(self.layoutWidget)
        ...
        self.label_alias_alias = QtGui.QLabel(self.layoutWidget)
        ...
        self.list_alias = QtGui.QComboBox(self.layoutWidget)
        ...
        self.label_label_alias = QtGui.QLabel(self.layoutWidget)
        ...
        self.label_alias = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.label_body_alias = QtGui.QLabel(self.layoutWidget)
        ...
        self.body_alias = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.save_alias = QtGui.QPushButton(self.layoutWidget)
        ...
        self.delete_alias = QtGui.QPushButton(self.layoutWidget)
        ...
        self.layoutWidget1 = QtGui.QWidget(self.tab_option)
        self.layoutWidget1.setGeometry(QtCore.QRect(5,7,296,266))
        ...
        self.save_preferences = QtGui.QPushButton(self.layoutWidget1)
