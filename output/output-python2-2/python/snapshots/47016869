...
class UtilTestCase(unittest.TestCase):
    ...
    def testunique(self):
        list1 = [ 5, 2, 3, 4 ]
        list2 = [ 5, 2, 3, 4, 5, 3 ]
        self.assertEquals(str(sorted(util.unique(list1))), str(sorted(list1)))
        self.assertEquals(str(sorted(util.unique(list2))), str(sorted(list1)))
        self.assertNotEquals(str(sorted(util.unique(list2))), str(sorted(list2)))
