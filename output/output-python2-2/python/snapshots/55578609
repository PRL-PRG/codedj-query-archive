...
class Generator:   
    ...
    # return nothing, just modify the trackDictionary argument
    def generate( self, 
        ...
        self.rythmShuffle = RythmShuffle( nbeats )
        self.rythmReverse = RythmReverse( nbeats )
        ...
        for i in range( nbeats ):
            self.harmonicSequence.append( 
                    GenerationConstants.CHORDS_TABLE[ self.makeHarmonicSequence.getNextValue( 2, len( GenerationConstants.CHORDS_TABLE ) - 1 ) ] )
