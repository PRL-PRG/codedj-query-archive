...
WMEICON = os.path.abspath('actors/img/wme.png')
WMECONOFF = os.path.abspath('actors/img/wmeoff.png')

class Actor(DeviceActor):

    __required__ = {'info.product':'PocketPC'}
    ...
    def on_removed(self):
        self.msg_render.show("PDA", "Dispositivo PDA desconectado",
                WMEOFF)
