...
class Ui_option(object):
    def setupUi(self, option):
        ...
        self.gridlayout2.addWidget(self.label_conn_alias,0,0,1,2)
        ...
        self.gridlayout2.addWidget(self.list_conn_alias,0,2,1,2)
        ...
        self.gridlayout2.addWidget(self.label_alias_alias,1,0,1,1)

        spacerItem5 = QtGui.QSpacerItem(80,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem5,1,1,1,2)
        ...
        self.gridlayout2.addWidget(self.list_alias,1,3,1,1)
        ...
        self.gridlayout2.addWidget(self.label_label_alias,2,0,1,1)

        spacerItem6 = QtGui.QSpacerItem(80,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem6,2,1,1,2)
        ...
        self.gridlayout2.addWidget(self.label_alias,2,3,1,1)
        ...
        self.gridlayout2.addWidget(self.label_body_alias,3,0,1,1)
        ...
        self.gridlayout2.addWidget(self.body_alias,3,1,1,3)
        ...
        self.gridlayout3 = QtGui.QGridLayout(self.layoutWidget_3)
        ...
        self.gridlayout4.addWidget(self.label_conn_macro,0,0,1,2)
        ...
        self.gridlayout4.addWidget(self.list_conn_macro,0,2,1,2)
        ...
        self.gridlayout4.addWidget(self.label_macro_macro,1,0,1,1)

        spacerItem9 = QtGui.QSpacerItem(80,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Minimum)
        self.gridlayout4.addItem(spacerItem9,1,1,1,2)
        ...
        self.gridlayout4.addWidget(self.list_macro,1,3,1,1)
        ...
        self.gridlayout4.addWidget(self.label_keys_macro,2,0,1,1)
        ...
        self.gridlayout4.addWidget(self.keys_macro,2,3,1,1)
        ...
        self.gridlayout4.addWidget(self.label_command_macro,3,0,1,1)
        ...
        self.gridlayout4.addWidget(self.command_macro,3,1,1,3)
        ...
        self.gridlayout4.addWidget(self.register_macro,2,1,1,2)
        ...
        self.gridlayout3.addItem(spacerItem10,1,0,1,2)

        spacerItem11 = QtGui.QSpacerItem(91,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout3.addItem(spacerItem11,2,0,1,1)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(2,10,296,81))
        self.layoutWidget1.setObjectName("layoutWidget1")

        self.gridlayout5 = QtGui.QGridLayout(self.layoutWidget1)
        ...
        self.gridlayout5.addWidget(self.echo_color,0,2,1,1)
        ...
        self.gridlayout5.addWidget(self.keep_text,1,0,1,2)

        spacerItem12 = QtGui.QSpacerItem(76,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(2,20,296,156))
        self.layoutWidget_4.setObjectName("layoutWidget_4")

        self.gridlayout6 = QtGui.QGridLayout(self.layoutWidget_4)
        self.gridlayout6.setHorizontalSpacing(2)
        self.gridlayout6.setVerticalSpacing(0)
        self.gridlayout6.setObjectName("gridlayout6")

        self.save_log = QtGui.QCheckBox(self.layoutWidget_4)
        self.save_log.setMinimumSize(QtCore.QSize(100,0))
        self.save_log.setObjectName("save_log")
        self.gridlayout6.addWidget(self.save_log,0,0,1,1)

        spacerItem13 = QtGui.QSpacerItem(166,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout6.addItem(spacerItem13,0,1,1,1)

        spacerItem14 = QtGui.QSpacerItem(276,99,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout6.addItem(spacerItem14,1,0,1,2)

        self.hboxlayout3 = QtGui.QHBoxLayout()
        self.hboxlayout3.setObjectName("hboxlayout3")

        spacerItem15 = QtGui.QSpacerItem(209,26,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        ...
        self.gridlayout6.addLayout(self.hboxlayout3,2,0,1,2)
