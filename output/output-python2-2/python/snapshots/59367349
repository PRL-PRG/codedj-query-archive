...
class Ui_RightWidget(object):
    def setupUi(self, RightWidget):
        ...
        RightWidget.resize(QtCore.QSize(QtCore.QRect(0,0,256,615).size()).expandedTo(RightWidget.minimumSizeHint()))
        RightWidget.setMinimumSize(QtCore.QSize(255,615))

        self.text_map = QtGui.QTextEdit(RightWidget)
        self.text_map.setGeometry(QtCore.QRect(0,0,256,426))
        ...
        self.label_health.setMinimumSize(QtCore.QSize(110,0))
        ...
        self.label_mana.setMinimumSize(QtCore.QSize(110,0))
        ...
        self.label_movement.setMinimumSize(QtCore.QSize(110,0))
