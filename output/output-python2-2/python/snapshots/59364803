...
class Ui_option(object):
    def setupUi(self, option):
        ...
        option.resize(QtCore.QSize(QtCore.QRect(0,0,313,306).size()).expandedTo(option.minimumSizeHint()))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(7,11,296,261))
        ...
        self.groupBox_2 = QtGui.QGroupBox(self.tab_option)
        self.groupBox_2.setGeometry(QtCore.QRect(10,104,291,176))
        self.groupBox_2.setFlat(True)
        self.groupBox_2.setObjectName("groupBox_2")

        self.layoutWidget3 = QtGui.QWidget(self.groupBox_2)
        self.layoutWidget3.setGeometry(QtCore.QRect(2,20,286,151))
        self.layoutWidget3.setObjectName("layoutWidget3")

        self.gridlayout7 = QtGui.QGridLayout(self.layoutWidget3)
        self.gridlayout7.setHorizontalSpacing(2)
        ...
        self.gridlayout7.addLayout(self.hboxlayout3,2,0,1,2)
