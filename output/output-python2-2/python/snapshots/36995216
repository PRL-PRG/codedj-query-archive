...
command = '/users/rhiju/python/pdb2casp.py %smodel_?.pdb %s' % (prefix,oligomer_flag)
print command
system(command)

command = 'ls %smodel_?.casp > cartoons.list' % (prefix)
print command
system(command)
...
command = '/users/rhiju/python/combine_new_plots.py cartoons.ps 3 2 ??.ps -l'
print command
system(command)

command = '/users/rhiju/python/printonphaser.py cartoons.ps'
print command
system(command)
