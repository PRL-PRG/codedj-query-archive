...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.toolDownAll=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"下载更新"), wx.Bitmap("E:\\Python\\WxGladeFrames\\bitmaps\\DownAll.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _(u"下载所有课件，更新公告"), "")
        self.toolDownAllFiles=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"下载课件"), wx.Bitmap("E:\\Python\\WxGladeFrames\\bitmaps\\DownFile.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _(u"下载所有课件"), "")
        self.toolRefreshNotes=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"更新公告"), wx.Bitmap("E:\\Python\\WxGladeFrames\\bitmaps\\Notice.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _(u"更新所有公告"), "")
        self.tollRefreshAll=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"刷新"), wx.Bitmap("E:\\Python\\WxGladeFrames\\bitmaps\\Refresh.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _(u"刷新所有课件列表"), "")
        self.toolStop=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"停止"), wx.Bitmap("E:\\Python\\WxGladeFrames\\bitmaps\\Stop.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _(u"停止"), "")
        # Tool Bar end
